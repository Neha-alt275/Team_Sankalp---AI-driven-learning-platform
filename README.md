...
Track learning patterns and quiz performance

Identify strengths and weak concepts

Recommend what to study, how to study, and when to revise
...
The platform acts as a personal AI study guide, promoting active learning and continuous improvement.
 ...
 AI-based concept extraction & knowledge graphs

 Smart note generation (Cornell, Outline, Mind Maps)
...
This project is developed for academic and hackathon purposes. Licensing can be updated as required.
 ...
 Uses student’s own study material

 Converts passive learning into active learning

 Saves time by focusing on high-priority topics
